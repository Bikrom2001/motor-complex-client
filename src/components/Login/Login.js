        ...
        <div className='h-[650px] flex justify-center items-center'>
            <div className="w-full login-container max-w-md p-8 space-y-3  dark:text-gray-100">
                ...
                <div className="flex justify-center space-x-4">
                    ...
                    <button aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-black focus:ring-violet-400">
                ...
                <p className="text-xs text-center sm:px-6 dark:text-black">New to Motor Complex ?
